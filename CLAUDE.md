# CLAUDE.md — working on simdblas

Instructions for coding agents. Read the required documents before changing
anything; this file is the summary, the documents are the detail. It agrees
with AGENTS.md, which is the same contract for non-Claude agents.
